...
<html lang="id">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login - <?php echo $this->app->get('store_name'); ?></title>
		...
		<![endif]-->
		<style>
			.login-title h2 { font-size:25px; font-weight: 600; font-family: 'Lobster', cursive;  }
			.text-red { color: red; }
						...
						<div class="login-container pd-top">
							...
							<div class="center login-title">
								<h2>
									...
									<span class="white" id="id-text2"> & <span class="red">Resto</span> Billing System </span>
								</h2>
								<h4 class="white" id="id-company-text"><?php echo $this->app->get('store_name'); ?></h4>
							</div>
