<div class="row">
	...
	<?php echo form_open_multipart(current_url(), array('class' => 'form-horiontal')); ?>
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-4">
		    		<input type="hidden" class="form-control" name="item_ID" value="<?php echo set_value('item_ID'); ?>">
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-5">
		      		...
		      		?>
						<option value="<?php echo $row->ps_ID; ?>" <?php if(set_value('category')==$row->ps_ID) echo "selected"; ?>><?php echo $row->product_sales; ?></option>
		      		<?php  
		      		endforeach;
		      		?>
		      		</select>
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-9">
		      		<textarea name="description" class="form-control" id="" cols="3" rows="4"><?php echo set_value('description'); ?></textarea>
		    	</div>
		  	</div>
		  	<div class="form-group col-md-12">
		  	...
		  	<div class="form-group col-md-12">
		    	...
		    	<div class="col-sm-4">
					<div class="radio-inline">
						<label>
							<input name="status" class="ace ace-radio-2" type="radio" value="available" <?php if(set_value('status')=='available') echo "checked"; ?>/>
							<span class="lbl"> Available</span>
						</label>
					</div>
					<div class="radio-inline">
						<label>
							<input name="status" class="ace ace-radio-2" type="radio" value="unavailable" <?php if(set_value('status')=='unavailable') echo "checked"; ?>/>
