<div class="row">
	...
	<?php 
		echo form_open_multipart(site_url('sell_category/bulk_action/update'), array('class' => 'form-horiontal')); 
		foreach($this->input->post('sales') as $key => $value) :
			$get = $this->category->get($value);
			echo form_hidden('categories[]', $get->ps_ID); 
	?>
			  ...
			  <div class="col-md-12">
				<div class="clearfix form-actions">
					<div class="col-md-offset-4 col-md-9">
						<button name="action" value="update" class="btn btn-info" type="submit">
